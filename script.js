...
const translations = {
    es: {
        ...
        "actions.previewCv": "Vista previa",
        ...
        "actions.contactMe": "Contáctame",
        "actions.backToTop": "Volver arriba",

        "projects.eyebrow": "Proyectos destacados",
        "projects.titleMain": "Ideas que se convirtieron",
    ...
    en: {
        ...
        "actions.previewCv": "Preview",
        "actions.openCv": "Open CV",
        ...
        "projects.titleMain": "Ideas that became",
        "projects.titleAccent": "real experiences.",
        ...
        "cv.eyebrow": "Resume",
        "cv.titleMain": "Explore my academic",
...
(() => {
    ...
    let cvDownloadBlob = null;
    let cvDownloadFile = null;
    ...
    function fallbackCvDownload(blob) {
        if (!blob) {
            return false;
        }
